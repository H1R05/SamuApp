...
const CounterCard = ({ number, label, Icon }: CounterCardProps) => (
  <div className="bg-gradient-to-r cursor-default from-slate-50 to-slate-200 px-8 py-6 rounded-lg shadow hover:bg-night hover:text-verdigris hover:scale-110 transform duration-300 hover:shadow-2xl">
