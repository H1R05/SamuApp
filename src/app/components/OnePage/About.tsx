...
export default function About() {
  return (
    <>
      <section
        id="about"
        className="relative min-h-screen flex flex-col justify-center bg-night px-8 py-16"
      >
        <div className="container mx-auto text-center max-w-3xl">
          ...
          <p className="text-white/80 leading-relaxed mb-8 text-2xl">
            Sin da piccolo sono stato affascinato dalla tecnologia e
            dall’informatica. Mi piace capire come funzionano le cose e
            risolvere problemi con creatività. Ora, a 23 anni, ho deciso di
            seguire la mia vera passione: studiare informatica per costruire il
            mio futuro, passo dopo passo, con entusiasmo e determinazione.
          </p>
          <a href="">
